...
| <a name="input_enable_cluster_deletion_protection"></a> [enable\_cluster\_deletion\_protection](#input\_enable\_cluster\_deletion\_protection) | If Terraform is allowed to delete the cluster. | `bool` | `true` | no |
